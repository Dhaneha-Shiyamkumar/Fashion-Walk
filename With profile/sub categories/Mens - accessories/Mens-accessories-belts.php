...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Mens-accessories-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
...
<body>
			  ...
			  <ul>
				<li>
					...
					<ul>
						...
						<li><a href="../Mens - causal/Mens-casual wear-pants.php">Pants</a></li>
	...
	<h2 class="title"><a href="Mens-accessories all.php">MENS</a><span class="sub-head"> Accessories</span></h2>
		<div class="filter">
			<ul>
				<li class="list" data-filter="All"><a href="Mens-accessories all.php">All</a></li>
				<li class="list" data-filter="Shirts"><a href="Mens-accessories-belts.php">Belts</a></li>
				<li class="list" data-filter="Shirts"><a href="Mens-accessories-bows&ties.php">Bows & Ties</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from mabelts";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <img src="belts/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view belts.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
  ...
  crossorigin="anonymous"></script>
	<script src="Mens-accessories-javascript.js" type="text/javascript"></script>
</body>
</html>
