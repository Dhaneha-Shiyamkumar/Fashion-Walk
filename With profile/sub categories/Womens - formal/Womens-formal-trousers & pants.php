...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Womens-formal-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
...
<body>
	...
	<h2 class="title"><a href="Womens-formal all.php">WOMENS</a><span class="sub-head"> Formal Wear</span></h2>
		<div class="filter">
			<ul>
				<li class="list" data-filter="All"><a href="Womens-formal all.php">All</a></li>
				<li class="list" data-filter="Casual"><a href="Womens-formal-shirts & tops.php">Shirts & Tops</a></li>
				<li class="list" data-filter="All"><a href="Womens-formal-trousers & pants.php">Trousers & Pants</a></li>
				<li class="list" data-filter="All"><a href="Womens-formal-skirts.php">Skirts</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from wftrousers";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <p><strong><a href="view trousers.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
  ...
  crossorigin="anonymous"></script>
	<script src="Womens-formal-javascript.js" type="text/javascript"></script>
</body>
</html>
