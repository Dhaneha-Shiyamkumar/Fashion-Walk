...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Womens-nightwear-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
...
<body>
	...
	<h2 class="title"><a href="Womens-nightwear all.php">WOMENS</a><span class="sub-head"> Night Wear</span></h2>
		<div class="filter">
			<ul>
				<li class="list active" data-filter="All"><a href="Womens-nightwear all.php">All</a></li>
				<li class="list" data-filter="Casual"><a href="Womens-nightwear-pijama.php">Pijama</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from wnpijama";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <img src="pijama/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view pijama.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
  ...
  crossorigin="anonymous"></script>
	<script src="Womens-nightwear-javascript.js" type="text/javascript"></script>
</body>
</html>
