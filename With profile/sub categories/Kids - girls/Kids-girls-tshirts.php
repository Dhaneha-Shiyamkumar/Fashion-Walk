...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Kids-girls-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
...
<body>
	...
	<h2 class="title"><a href="Kids-girls all.php">KIDS</a><span class="sub-head"> Girls</span></h2>
		<div class="filter">
			<ul>
				<li class="list active" data-filter="All"><a href="Kids-girls all.php">All</a></li>
				<li class="list" data-filter="All"><a href="Kids-girls-tshirts.php">T-Shirts</a></li>
				<li class="list" data-filter="All"><a href="Kids-girls-jeans.php">Jeans</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from kgtshirts";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
  ...
  crossorigin="anonymous"></script>
	<script src="Kids-girls-javascript.js" type="text/javascript"></script>
</body>
</html>
