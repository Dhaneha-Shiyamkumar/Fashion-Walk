...
<div class="small-container">
  <div class="row">
			...
			$sql="select * from kgjeans where PID='{$_GET["id"]}'";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <table class="table">
     <tr>
	 <td><img src="Jeans/'. $row['PIC'] .'" alt="" class="large" ></td>
	 <td>
   ...
   <div class="col-1">
     ...
     <p><strong><a href="view jeans.php?id='. $row['PID'] .'">'. $row['PNAME'] .'</a></strong></p>
