...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Mens-formal wear-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
...
<body>
	...
	<h2 class="title"><a href="Mens-formal wear all.php">MENS</a><span class="sub-head"> Formal Wear</span></h2>
		<div class="filter">
			<ul>
				<li class="list" data-filter="All"><a href="Mens-formal wear all.php">All</a></li>
				<li class="list" data-filter="Shirts"><a href="Mens-formal wear-shirts.php">Shirts</a></li>
				<li class="list" data-filter="Shorts"><a href="Mens-formal wear-trousers.php">Trousers</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from mftrousers";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <img src="trousers/'. $row['PIC'] .'" alt="" class="img-responsive" >
  ...
  crossorigin="anonymous"></script>
	<script src="Mens-formal wear-javasciprt.js" type="text/javascript"></script>
</body>
</html>
