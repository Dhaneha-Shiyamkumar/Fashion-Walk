...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Womens-sports-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
...
<body>
	...
	<h2 class="title"><a href="Womens-sports all.php">WOMENS</a><span class="sub-head"> Sports</span></h2>
		<div class="filter">
			<ul>
				<li class="list active" data-filter="All"><a href="Womens-sports all.php">All</a></li>
				<li class="list" data-filter="Casual"><a href="Womens-sports-tops.php">Tops</a></li>
				<li class="list" data-filter="Casual"><a href="Womens-sports-t-shirts.php">T-Shirts</a></li>
				<li class="list" data-filter="Casual"><a href="Womens-sports-tights.php">Tights</a></li>
				<li class="list" data-filter="All"><a href="Womens-sports-pants.php">Pants</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from wstshirts";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <img src="T-shirts/'. $row['PIC'] .'" alt="" class="img-responsive" >
  ...
  crossorigin="anonymous"></script>
	<script src="Womens-sports-javascript.js" type="text/javascript"></script>
</body>
</html>
