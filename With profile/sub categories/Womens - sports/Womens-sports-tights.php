...
<body>
   ...
   <div class="col-1">
     ...
     <img src="tights/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view tights.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
