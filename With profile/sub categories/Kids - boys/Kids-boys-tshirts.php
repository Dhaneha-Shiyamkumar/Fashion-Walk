...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Kids-boys-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
	  <link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">
	  <link rel="shortcut icon" type="image/jpg" href="../../../img/correctedlogo.png">
	<title>KIDS | Fashion Walk</title>
	</head>
<body>
	...
	<h2 class="title"><a href="Kids-boys all.php">KIDS</a><span class="sub-head"> Boys</span></h2>
		<div class="filter">
			<ul>
				<li class="list active" data-filter="All"><a href="Kids-boys all.php">All</a></li>
				<li class="list" data-filter="Casual"><a href="Kids-boys-shirts.php">Shirts</a></li>
				<li class="list" data-filter="All"><a href="Kids-boys-pants.php">Pants</a></li>
				<li class="list" data-filter="All"><a href="Kids-boys-jeans.php">Jeans</a></li>
				<li class="list" data-filter="All"><a href="Kids-boys-tshirts.php">T-Shirts</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from kbtshirts";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <img src="ktshirts/'. $row['PIC'] .'" alt="" class="img-responsive" >
  ...
  crossorigin="anonymous"></script>
	<script src="Kids-boys-javascript.js" type="text/javascript"></script>
</body>
</html>
