...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Kids-sports-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
...
<body>
	...
	<h2 class="title"><a href="Kids-sports all.php">KIDS</a><span class="sub-head"> Sports</span></h2>
		<div class="filter">
			<ul>
				<li class="list active" data-filter="All"><a href="Kids-sports all.php">All</a></li>
				<li class="list" data-filter="All"><a href="Kids-sports-accessories.php">Accessories</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from ksaccessories";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <img src="accessories/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view accessories.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
  ...
  crossorigin="anonymous"></script>
	<script src="Kids-sports-javascript.js" type="text/javascript"></script>
</body>
</html>
