...
<body>
   ...
   <div class="col-1">
     ...
     <img src="polo/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view polos.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
