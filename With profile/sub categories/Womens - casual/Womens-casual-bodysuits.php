...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Womens-casual-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
	  <link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">
	  <link rel="shortcut icon" type="image/jpg" href="../../../img/correctedlogo.png">
	<title>WOMENS | Fashion Walk</title>
	</head>
<body>
	
	<!-- Navigation Bar -->
	<nav>
		<div><a href="../../../index with profile.html"><img class="logo" src="../../../img/correctedlogo.png" alt="Logo"></a></div>
	...
	<h2 class="title"><a href="Womens-casual all.php">WOMENS</a><span class="sub-head"> Casual Wear</span></h2>
		<div class="filter">
			<ul>
				<li class="list active" data-filter="All"><a href="Womens-casual all.php">All</a></li>
				<li class="list" data-filter="Casual"><a href="Womens-casual-leggings.php">Leggings & Tights</a></li>
				<li class="list" data-filter="All"><a href="Womens-casual-tanktops.php">Tank Tops</a></li>
				<li class="list" data-filter="All"><a href="Womens-casual-skirts & shorts.php">Skirt & Shorts</a></li>
				<li class="list" data-filter="All"><a href="Womens-casual-polos.php">Polos</a></li>
				<li class="list" data-filter="All"><a href="Womens-casual-skirts & shorts.php">Shirts</a></li>
				<li class="list" data-filter="All"><a href="Womens-casual-bodysuits.php">Bodysuits</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from wcbodysuits";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <img src="Body suits/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view bodysuits.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
		...
		<div class="inner-footer">
			...
			<div class="footer-items">
				<h2>Let us help you</h2>
					<div class="border"></div>
				<ul>
					<a href="../../../profile.html"><li>My Account</li></a>
  ...
  crossorigin="anonymous"></script>
	<script src="Womens-casual-javascript.js" type="text/javascript"></script>
</body>
</html>
