...
<body>
   ...
   <div class="col-1">
     ...
     <img src="tanktops/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view tanktops.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
