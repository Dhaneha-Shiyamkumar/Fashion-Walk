...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Mens-casual wear-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
	  <link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">
	  <link rel="shortcut icon" type="image/jpg" href="../../../img/correctedlogo.png">
	<title>MENS | Fashion Walk</title>
	</head>
<body>
	...
	<h2 class="title"><a href="Mens-casual wear all.php">MENS</a><span class="sub-head"> Casual Wear</span></h2>
		<div class="filter">
			<ul>
				<li class="list" data-filter="All"><a href="Mens-casual wear all.php">All</a></li>
				<li class="list" data-filter="Casual"><a href="Mens-casual wear-T-shirts.php">T-Shirts</a></li>
				<li class="list" data-filter="Jeans"><a href="Mens-casual wear-jeans.php">Jeans</a></li>
				<li class="list" data-filter="Polos"><a href="Mens-casual wear-polos.php">Polos</a></li>
				<li class="list" data-filter="Shirts"><a href="Mens-casual wear-shirts.php">Shirts</a></li>
				<li class="list" data-filter="Shorts"><a href="Mens-casual wear-shorts.php">Shorts</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from mctshirts";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <img src="Tshirts/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view tshirts.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
  ...
  crossorigin="anonymous"></script>
	<script src="Mens-casual wear-javascript.js" type="text/javascript"></script>
</body>
</html>
