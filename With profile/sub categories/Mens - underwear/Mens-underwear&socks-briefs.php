...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Mens-underwear&socks-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
...
<body>
	...
	<h2 class="title"><a href="Mens-underwear&socks all.php">MENS</a><span class="sub-head"> Underwear & Socks</span></h2>
		<div class="filter">
			<ul>
				<li class="list" data-filter="All"><a href="Mens-underwear&socks all.php">All</a></li>
				<li class="list" data-filter="Shorts"><a href="Mens-underwear&socks-briefs.php">Briefs</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from mubriefs";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <img src="briefs/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view briefs.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
  ...
  crossorigin="anonymous"></script>
	<script src="Mens-underwear&socks-javascript.js" type="text/javascript"></script>
</body>
</html>
