...
<div class="small-container">
  <div class="row">
			...
			$sql="select * from wasunglasses where PID='{$_GET["id"]}'";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <table class="table">
     <tr>
	 <td><img src="SUNGLASSES/'. $row['PIC'] .'" alt="" class="large" ></td>
	 <td>
   ...
   <div class="col-1">
     ...
     <p><strong><a href="view sunglasses.php?id='. $row['PID'] .'">'. $row['PNAME'] .'</a></strong></p>
