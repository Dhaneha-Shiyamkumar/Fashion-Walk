...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Womens-accessories-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
...
<body>
	...
	<h2 class="title"><a href="Womens-accessories all.php">WOMENS</a><span class="sub-head"> Accessories</span></h2>
		<div class="filter">
			<ul>
				<li class="list active" data-filter="All"><a href="Womens-accessories all.php">All</a></li>
				<li class="list" data-filter="Casual"><a href="Womens-accessories-Hair accessories.php">Hair Accessories</a></li>
				<li class="list" data-filter="All"><a href="Womens-accessories-makeup pouch.php">Makeup Pouch</a></li>
				<li class="list" data-filter="All"><a href="Womens-accessories-caps & hats.php">Caps & Hats</a></li>
				<li class="list" data-filter="All"><a href="Womens-accessories-sunglasses.php">Sunglasses</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from wasunglasses";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <img src="SUNGLASSES/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view sunglasses.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
  ...
  crossorigin="anonymous"></script>
	<script src="Womens-accessories-javascript.js" type="text/javascript"></script>
</body>
</html>
