...
<body>
   ...
   <div class="col-1">
     ...
     <img src="makeup pouch/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view makeup.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
