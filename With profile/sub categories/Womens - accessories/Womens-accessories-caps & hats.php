...
<body>
   ...
   <div class="col-1">
     ...
     <img src="WOMENS HATS/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view caps.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
