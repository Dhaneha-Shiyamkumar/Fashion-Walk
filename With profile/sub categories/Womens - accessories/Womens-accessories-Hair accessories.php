...
<body>
   ...
   <div class="col-1">
     ...
     <img src="hair accessories/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view hair.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
